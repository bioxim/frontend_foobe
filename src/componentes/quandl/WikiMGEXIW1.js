...
const Wiki = (props) => {
	...
	useEffect( () => {
		...
		const consultarAPI = async () => {
			...
			const datosConsulta = await clienteAxios.get('https://www.quandl.com/api/v3/datasets/CHRIS/MGEX_IW1.json?start_date=2020-02-15&end_date=2020-05-17&api_key=PaVTvJcxhxsypQDK-1Fn');
