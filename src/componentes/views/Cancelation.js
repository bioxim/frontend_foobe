...
const Cancelation = () => (
	<Fragment>
		<section className="py-10 py-md-14 overlay overlay-black overlay-60 bg-cover background-cancel-image">
	        ...
	        <div className="row justify-content-center">
	          <div className="col-12 col-md-10 col-lg-8 text-center">
	            ...
	            <p className="lead text-white-75 mb-0">
	              Foobe hopes you stay with us very soon.  If you have any doubt or problem to pay the membership, please contact us.
	            </p>
